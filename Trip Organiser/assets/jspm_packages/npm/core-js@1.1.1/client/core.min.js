...
(function(process) {
  !function(b, c, a) {
    ...
    !function(b) {
      ...
      var a = "undefined" != typeof self && self.Math == Math ? self : Function("return this")();
      b.exports = a, "number" == typeof c && (c = a);
    }, function(d, f, b) {
      var c = b(9),
          a = b(7).document,
      ...
      function defineProperty(a, c, e) {
        return e && d(i, c) ? (e.enumerable ? (d(a, b) && a[b][c] && (a[b][c] = !1), e = k(e, {enumerable: s(0, !1)})) : (d(a, b) || f(a, b, s(1, {})), a[b][c] = !0), p(a, c, e)) : f(a, c, e);
      }
      function defineProperties(a, b) {
        ...
        for (var c,
            ...
            e = 0,
            f = d.length; f > e; )
          defineProperty(a, c = d[e++], b[c]);
        return a;
      }
      function create(b, c) {
        return c === a ? k(b) : defineProperties(k(b), c);
      }
      function propertyIsEnumerable(a) {
        var c = G.call(this, a);
        return c || !d(this, a) || !d(i, a) || d(this, b) && this[b][a] ? c : !0;
      }
      function getOwnPropertyDescriptor(a, c) {
        var e = v(a = m(a), c);
        return !e || !d(i, c) || d(a, b) && a[b][c] || (e.enumerable = !0), e;
      }
      function getOwnPropertyNames(g) {
        for (var a,
            c = w(m(g)),
            e = [],
            f = 0; c.length > f; )
      ...
      function getOwnPropertySymbols(f) {
        for (var a,
            b = w(m(f)),
            c = [],
            e = 0; b.length > e; )
      ...
      var e = c(2),
          ...
          p = o ? function() {
            try {
              return k(f({}, b, {get: function() {
                  return f(this, b, {value: !1})[b];
                }}))[b] || f;
            } catch (a) {
          ...
          z = function(a) {
            var c = i[a] = k(h.prototype);
            return c._k = a, o && l && p(j, a, {
              configurable: !0,
              set: function(c) {
                d(this, b) && d(this[b], a) && (this[b][a] = !1), p(this, a, s(1, c));
              }
            }), c;
          };
      r || (h = function Symbol() {
      ...
      }, x(h.prototype, "toString", function() {
        return this._k;
      }), e.create = create, e.isEnum = propertyIsEnumerable, e.getDesc = getOwnPropertyDescriptor, e.setDesc = defineProperty, e.setDescs = defineProperties, e.getNames = A.get = getOwnPropertyNames, e.getSymbols = getOwnPropertySymbols, o && !c(37) && x(j, "propertyIsEnumerable", propertyIsEnumerable, !0));
      var t = {
        "for": function(a) {
          return d(n, a += "") ? n[a] : n[a] = h(a);
        },
      ...
      e.each.call("hasInstance,isConcatSpreadable,iterator,match,replace,search,species,split,toPrimitive,toStringTag,unscopables".split(","), function(a) {
        var b = B(a);
        t[a] = r ? b : z(b);
      }), l = !0, g(g.G + g.W, {Symbol: h}), g(g.S, "Symbol", t), g(g.S + g.F * !r, "Object", {
        create: create,
      ...
      }), q(h, "Symbol"), q(Math, "Math", !0), q(u.JSON, "JSON", !0);
    }, function(d, f, e) {
      var a = e(7),
      ...
      var b,
          ...
          e = f(7),
          k = f(134).set,
          j = e.MutationObserver || e.WebKitMutationObserver,
          i = e.process;
      if ("process" == f(11)(i))
        c = function() {
          i.nextTick(flush);
        ...
        new j(flush).observe(h, {characterData: !0}), c = function() {
          h.data = g = -g;
        };
      } else
        c = function() {
      ...
      l.exports = function asap(f) {
        var e = {
          fn: f,
          next: a
        };
        d && (d.next = e), b || (b = e, c()), d = e;
      };
    }, function(s, t, b) {
      var c,
          g,
      ...
      c(c.S, "Reflect", {construct: function construct(c, b) {
 ...
 while (!((c = d[b._i++]) in b._t));
      ...
      var b = a(2),
          d = a(26);
      c.exports = function ownKeys(a) {
        var c = b.getNames(d(a)),
            e = b.getSymbols;
